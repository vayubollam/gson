package suncor.com.android.uicomponents.swipe;
...
import suncor.com.android.uicomponents.anim.SuncorBounceInterpolator;
...
public class SwipeLayout extends FrameLayout {
    ...
    public void showHint(int dimensionPixelSize) {
        ...
        as.play(seconOpenAnimation).after(closeAnimation);
        as.play(closeAnimation.clone()).after(seconOpenAnimation);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (hintAnimator != null) {
            hintAnimator.cancel();
            getSurfaceView().setTranslationX(0);
            hintAnimator = null;
        }
