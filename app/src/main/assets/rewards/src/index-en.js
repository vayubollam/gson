...
window.onload = function () {
    ...
    document.getElementById("rewards-dollar-to-points-image").src="images/panel-2/dollars-litres-en.gif";
...
//    document.getElementById("rewards-exchange-image").src="images/panel-8/exchange-en.gif";
 }