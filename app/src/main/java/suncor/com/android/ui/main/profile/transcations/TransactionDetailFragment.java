...
public class TransactionDetailFragment extends MainActivityFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding.transactionToolbar.setNavigationOnClickListener(v -> Navigation.findNavController(requireView()).popBackStack());
        ...
        viewModel.getTransactionDetails(transactionId, true).observe(getViewLifecycleOwner(), result->{
            if (result.status == Resource.Status.LOADING) {
                ...
                try{
                    ...
                    binding.paymentTypeValue.setText(result.data.getPaymentType(requireContext(), false));
                    ...
                    binding.paymentTypeValue.setText("****");
                }
            }
        });
    }
