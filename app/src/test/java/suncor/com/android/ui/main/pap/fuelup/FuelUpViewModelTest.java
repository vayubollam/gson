...
public class FuelUpViewModelTest {
    ...
    public void test_google_pay_server_request_success() {
        LiveData<Resource<PayResponse>> response = viewModel.payByGooglePayRequest("00823", 2, 1,
                "\"{\\\"signature\\\":\\\"MEQCIDqFBoyAVVUztonjXoE8AVkvLqC80OeE2pwHJ0tHHCY8AiBMgz2Vu2KjugzilpRSyKfoZHNpYle6tbkCZRZRv6sYWw\\\\u003d\\\\u003d\\\",\\\"intermediateSigningKey\\\":{\\\"signedKey\\\":\\\"{\\\\\\\"keyValue\\\\\\\":\\\\\\\"MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEugtGsZ9nV3dXvcURJc\\/jzwRMUtslhbEK+epIibmzBtPMxxafS\\/ju6TQhLmm+cnE4+Tg10Sf2devCVuPvzzjbTg\\\\\\\\u003d\\\\\\\\u003d\\\\\\\",\\\\\\\"keyExpiration\\\\\\\":\\\\\\\"1640650908813\\\\\\\"}\\\\", "kountSessionID");
    ...
    @Test
    public void test_get_petro_points_balance() {
        String petroPoints = viewModel.getPetroPointsBalance();
        Assert.assertEquals(Boolean.TRUE, petroPoints.equals("2500"));
    }
